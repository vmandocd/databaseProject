    ...
    <table border="1">
	    ...
	    <!-- Add an HTML table header row to format the results -->
			...
			<th>Professor</th>
                    ...
                    <tr>
                        <form action="query3aiii.jsp" method="get">
			    <th>
	    ...
	    %>
		    ...
		    String w = request.getParameter("profname");
           		 ...
           		 "WHERE c.coursenumber = '"+v+"' AND f.facultyname = '"+w+"' " +
           		 "AND c.coursenumber = pc.pccoursenumber AND ft.teachingsectionid = cl.sectionid " +
            		 "AND ft.teachingfacultyname = f.facultyname AND pc.pcquarter = cl.classquarter AND pc.pcyear = cl.classyear " +
